                  ...
                  <div className="mt-9 md:mb-0 pb-14 md:pl-14 md:pr-11 px-4 md:px-0 w-full flex-col gap-y-6">
                    <div>
                      <div className="gap-[14px] sm:flex-nowrap flex-wrap">
                        <div className="mt-4">
                          <h3 className="text-black dark:text-[#4889B8] font-exo text-center font-medium">
                            Credit Amount
                          </h3>
                          <div className="flex overflow-hidden mt-4 justify-center">
                            <span className="inline-flex items-center px-4 rounded-l text-[#45DE26] bg-[#072457]">
                              $
                            </span>
                            <input
                              type="number"
                              className="h-12 w-28 bg-inputfild py-3 px-6 rounded-r focus:outline-none font-Exo text-[17.8px] text-white offerinput"
                            />
                          </div>
                        </div>
                        <div className="mt-4">
                          ...
                          <div className="overflow-hidden mt-4">
                            <textarea className=" h-40 md:w-[426px] w-full bg-inputfild py-3 px-6 rounded resize-none focus:outline-none font-Exo text-[17.8px] text-white offerinput"></textarea>
                          </div>
                        </div>
                      </div>
                    </div>
